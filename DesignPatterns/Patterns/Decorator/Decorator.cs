 ...
 * Adding behaviour without altering the class itself (Open/Close principle)
 * Need to be able to interact with existing structures
 *
 * Two options:
 *
 *      Inherit from required object if possible but some objects are sealed
 *      Build a decorator, which simply references the decorated object(s)
 *          - In R# this can be done below via generate delegating members from the _builder object
 *
 */
